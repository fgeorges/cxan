               ...
               <xsl:template name="main">
                  <page menu="home">
                     ...
                     <para>CXAN is comprised of two different facets: its server, and clients. The server
                        ...
                        integrate with the CXAN server. The <link uri="pkg/fgeorges/cxan-client"
                        ...
                        the CXAN server. The local on-disk repository manager is <link
                           uri="https://github.com/fgeorges/expath-pkg-java">expath-repo</link>.</para>
                     <para>If you are looking for an easy way to build a package out of your source
                        files, take a look at <link uri="http://expath.org/modules/xproject/"
                           >XProject</link> (CXAN ID <link uri="pkg/fgeorges">fgeorges</link>/<link
                           uri="pkg/fgeorges/xproject">xproject</link>) and at its <link
